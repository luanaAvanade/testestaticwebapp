...
import AtividadeEconomicaPrincipalCNAE from '@/services/AtividadeEconomicaPrincipalCNAE';
import OcupacaoPrincipalCNAE from '@/services/OcupacaoPrincipalCNAE';
...
export default function DadosGerais({
	...
	const CNAEFindAll = async () => {
		...
		const response = await AtividadeEconomicaPrincipalCNAE.findAll();
		if (response.data) {
			setAtividadeEconomicaPrincipalList(
	...
	const CNAEOcupacaoFindAll = async () => {
		dispatch(LoaderCreators.setLoading());
		const response = await OcupacaoPrincipalCNAE.findAll();
		if (response.data) {
